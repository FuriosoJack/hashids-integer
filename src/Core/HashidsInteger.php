...
/**
 * Class HashidsInteger
 * @author Juan Diaz <iam@furiosojack.com>
 */
class HashidsInteger implements HashidsIntegerInterface
{
    /**
     * The seps divider.
     *
     ...
     * @return void
     */
    public function __construct($salt = '', $minHashLength = 0, $alphabet = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890',$prefix = null,$prefixSeparator = "-")
    {
        $this->salt = $salt;
